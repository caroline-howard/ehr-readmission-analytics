...
- `outputs/figures/` contains selected PNG figures and the multi-panel utilization summary visual used in the README, report, and app.
- `outputs/analysis/` contains aggregate descriptive analysis, sensitivity analysis, and logistic regression outputs generated by the notebooks and scripts.
