...
- `02_descriptive_analysis.ipynb` generates Table 1, readmission summary, outpatient follow-up summary, ED revisit summary, and risk stratification outputs.
